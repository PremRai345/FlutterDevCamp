...
import 'package:flutter_dev_camp/category.dart';
import 'package:flutter_dev_camp/model.dart';
import 'package:flutter_dev_camp/view.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 3, 108, 125),
        title: const Text(
          "The News",
